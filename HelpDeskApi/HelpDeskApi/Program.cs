...
{
    options.SwaggerDoc("v1", new() { Title = "HelpDeskApi", Version = "v1" });
...
var key = Encoding.ASCII.GetBytes(jwtSettings["Key"] ?? throw new InvalidOperationException("JWT Key não configurada!"));
